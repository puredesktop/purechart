# Develop purechart and build new apps
...
| Goal | Start here |
| --- | --- |
| Add a feature to purechart | Fork or clone this repository and prepare its shared dependencies, or select its editable project in purefactory when available. |
...
1. Fork [puredesktop/purechart](https://github.com/puredesktop/purechart) if you want your own repository, then clone your fork locally. Create a branch for your change.
